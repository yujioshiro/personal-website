...
export default function ProjectsPage() {
  return (
    <Layout>
        ...
        <div class="">
          <article>
            <h2>Next meetup: November 22nd, 6pm</h2>
            ...
            <ul>
              ...
              <li>we are part of Learn Teach Code LA, you can RSVP to the event <a href="https://www.meetup.com/learnteachcode/events/297130353/" target='_blank'>here</a>!</li>
